...
@section('content_title',__("Round Shift"))
@section('content_description',__("Round Shift Management"))
@section('breadcrumbs')
    ...
    <div class="col-md-10">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">{{__('Add New Round Shift')}}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->

            <form method="POST" action="{{route('master/save_round_shift')}}" class="form-horizontal">
                @csrf
                <div class="box-body">
    ...
    <div class="col-md-10">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">{{__('Round Shift Details')}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
