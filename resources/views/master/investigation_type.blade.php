...
@section('content_title',__("Investigation"))
@section('content_description',__("Investigation Management"))
@section('breadcrumbs')
    ...
    <div class="col-md-10">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">{{__('Add New Investigation Type')}}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->

            <form method="POST" action="{{route('master/save_investigation_type')}}" class="form-horizontal">
                @csrf
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="ward_num">{{__('Type')}}<span style="color:red">*</span></label></label>
                        <div class="col-sm-10">
                                <select class="form-control" name="type" required id="type">
                                    <option value="investigation_sheet">Investigation Sheet</option>
    ...
    <div class="col-md-10">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">{{__('Investigation Type Details')}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
