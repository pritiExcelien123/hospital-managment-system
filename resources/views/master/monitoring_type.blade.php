...
@section('content_title',__("Monitoring"))
@section('content_description',__("Monitoring Management"))
@section('breadcrumbs')
    ...
    <div class="col-md-10">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">{{__('Add New Monitoring Type')}}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->

            <form method="POST" action="{{route('master/save_monitoring_type')}}" class="form-horizontal">
                @csrf
                <div class="box-body">
    ...
    <div class="col-md-10">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">{{__('Monitoring Type Details')}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
